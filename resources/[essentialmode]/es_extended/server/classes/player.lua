function CreateExtendedPlayer(player, accounts, inventory, job, loadout, name, lastPosition)
	...
	self.setMoney = function(money)
		...
		if money >= 0 then
			self.addInventoryItem("cash", money) --self.player.setMoney(money)
			self.player.setMoney(money) --oyuncu2.addInventoryItem('cash', money)
		else
